"""
Django settings for automatic_attendence_system project.
...
ROOT_URLCONF = 'automatic_attendence_system.urls'
...
WSGI_APPLICATION = 'automatic_attendence_system.wsgi.application'
