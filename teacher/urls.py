...
path('teacher_particular_course',views.teacher_particular_course,name='tea_par_course'),
path('teacher_student_attendence',views.teacher_student_attendence,name='teacherstudent_attendence')
]